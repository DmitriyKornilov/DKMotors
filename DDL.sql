...
/* Список двигателей на контроле */
CREATE TABLE IF NOT EXISTS CONTROLLIST (
    ControlID INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,
    MotorID   INTEGER UNIQUE NOT NULL,
    Note      TEXT    NOT NULL,
    CONSTRAINT FK_CONTROLLIST_MOTORID FOREIGN KEY (MotorID) REFERENCES MOTORLIST(MotorID) ON UPDATE CASCADE ON DELETE CASCADE
);
