...
INSERT OR IGNORE INTO  RECLAMATIONREASONS (ReasonID, ReasonName) VALUES (0, '<не указана>');
INSERT OR IGNORE INTO  RECLAMATIONREASONS (ReasonID, ReasonName) VALUES (1, 'Некачественные комплектующие');
INSERT OR IGNORE INTO  RECLAMATIONREASONS (ReasonID, ReasonName) VALUES (2, 'Дефект сборки/изготовления');
INSERT OR IGNORE INTO  RECLAMATIONREASONS (ReasonID, ReasonName) VALUES (3, 'Неправильная эксплуатация');
INSERT OR IGNORE INTO  RECLAMATIONREASONS (ReasonID, ReasonName) VALUES (4, 'Неисправность локомотива');
