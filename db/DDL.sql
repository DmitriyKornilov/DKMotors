...
/* Типы двигателей */
CREATE TABLE IF NOT EXISTS MOTORTYPES (
    TypeID    INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,
    MotorType TEXT    UNIQUE NOT NULL
);
INSERT OR IGNORE INTO  MOTORTYPES (TypeID, MotorType) VALUES (0, '<не указан>');
INSERT OR IGNORE INTO  MOTORTYPES (TypeID, MotorType) VALUES (1, 'АНЭМ225');
INSERT OR IGNORE INTO  MOTORTYPES (TypeID, MotorType) VALUES (2, '7АЖ225');
INSERT OR IGNORE INTO  MOTORTYPES (TypeID, MotorType) VALUES (3, 'АЭВ71');
INSERT OR IGNORE INTO  MOTORTYPES (TypeID, MotorType) VALUES (4, 'АЖВ180');
INSERT OR IGNORE INTO  MOTORTYPES (TypeID, MotorType) VALUES (5, 'АЭВ180');
INSERT OR IGNORE INTO  MOTORTYPES (TypeID, MotorType) VALUES (6, 'АЭК200');
...
CREATE TABLE IF NOT EXISTS MOTORNAMES (
    ...
    CONSTRAINT FK_MOTORNAMES_TYPEID FOREIGN KEY (TypeID) REFERENCES MOTORTYPES(TypeID) ON UPDATE CASCADE ON DELETE SET DEFAULT
);
INSERT OR IGNORE INTO  MOTORNAMES (NameID, MotorName, TypeID) VALUES (0, '<не указано>', 0);
INSERT OR IGNORE INTO  MOTORNAMES (NameID, MotorName, TypeID) VALUES (1, 'АНЭМ225L4УХЛ2 IM1001', 1);
INSERT OR IGNORE INTO  MOTORNAMES (NameID, MotorName, TypeID) VALUES (2, 'АНЭМ225L4УХЛ2 IM1002', 1);
INSERT OR IGNORE INTO  MOTORNAMES (NameID, MotorName, TypeID) VALUES (3, '7АЖ225М6У2 IМ2001', 2);
INSERT OR IGNORE INTO  MOTORNAMES (NameID, MotorName, TypeID) VALUES (4, 'АЭВ71А2У2 IМ2003', 3);
INSERT OR IGNORE INTO  MOTORNAMES (NameID, MotorName, TypeID) VALUES (5, 'АЖВ180МВ2У2 IМ3033', 4);
INSERT OR IGNORE INTO  MOTORNAMES (NameID, MotorName, TypeID) VALUES (6, 'АЭВ180М2УХЛ1', 5);
INSERT OR IGNORE INTO  MOTORNAMES (NameID, MotorName, TypeID) VALUES (7, 'АЭК200L6У2 IМ1003', 6);
